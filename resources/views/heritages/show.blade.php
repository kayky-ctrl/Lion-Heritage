...
@if ($post['cover'])
<meta property="og:image" content="{{ asset('content-pages/images/' . $post['cover']) }}">
@endif
...
/* Capitular no primeiro parágrafo */
...
<article class="bg-white rounded-lg shadow p-6">
    @if ($post['cover'])
        <div class="cover-image mb-6" id="coverImage">
            <img src="{{ asset('content-pages/images/' . $post['cover']) }}" alt="{{ $post['title'] }}">
...
@section('scripts')
<script>
// Efeito de holofote na imagem de capa
...
// Modal para imagens do conteúdo
